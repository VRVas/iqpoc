  ...
  properties: {
    ...
    cors: {
      corsRules: [
        {
          allowedOrigins: ['*']
          allowedMethods: ['GET', 'HEAD', 'PUT', 'POST', 'DELETE', 'OPTIONS', 'MERGE', 'PATCH']
          allowedHeaders: ['*']
          exposedHeaders: ['*']
